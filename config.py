...
def get_args():
    ...
    parser.add_argument('--dataset', type=str, default='cifar10', help='dataset used for training (cifar10, fashionmnist, yahoo)')
    ...
    parser.add_argument('--datadir', type=str, required=False, default="./dataset/data/", help="Data directory")
    ...
    parser.add_argument('--alpha', type=float, default=1, help="Optimization problem hyperparameters")
